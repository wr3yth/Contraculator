<template>
  <div class="flex h-screen items-center justify-center">
    <div
      ...
      <label for="numerals" class="flex flex-col">
        Input alternative numeric values:
        <input id="numerals" type="text" placeholder="0123456789" />
      </label>
      <label for="in-decimal" class="flex flex-col">
      ...
      <div id="resultContainer" class="mb-5 flex justify-between gap-3">
        <ResultBox id="resultBox" class="flex-1"></ResultBox>
        <ResultBox id="resultBox2" class="flex-1"></ResultBox>
      </div>
      <label for="calculation" class="flex flex-col">
        Contraculation box:
        <input id="calculation" type="text" placeholder="user input" />
      </label>
    </div>
  </div>
</template>
...
onMounted(() => {
  ...
  function updateResultBox2() {
    ...
    resultBox2.innerHTML =
      'in decimal: ' + inDecimal.placeholder + '<br>Base: ' + base;
  }
